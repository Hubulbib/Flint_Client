...
function NameAndDesc(name) {
    ...
    function str(n, s, v) {
        return `Котлы комании Flint предназначены для отопления жилых домов и зданий коммунально-бытового назначения. Данный котел обладает номинальной мощностью ${n}. Способен отапливать помещения площадью до ${s}. Объём воды в котле составляет не более ${v}.`
    }
