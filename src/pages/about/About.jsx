        ...
        <div className='about__main__div'>
            ...
            <div className='about__first'>
                <div className='about__first__div'>
                    <h1 className='second__h1'>Компания Flint располагается на берегу Азовского моря в городе Таганрог. Деятельность компании направлена на производство качественных и высокоэффективных газовых котлов. Компания Flint намерена создавать долгосрочные ценности за счет ускоренного роста и увеличения прибыльности в рамках упрощенной и более гибкой структуры.</h1>
                </div>
            ...
            <div className='about__third'>
                ...
                <div className='about__third__h1'><h1>При производстве котлов Flint применяются самые современные и передовые технологии в области лазерной резки и компрессного оборудования. Все наши продукты проходят полный цикл тестирования</h1></div>
            </div>
        </div>
    )
}
